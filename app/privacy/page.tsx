    ...
    return (
        <div className="min-h-screen pt-24 pb-10 px-4 md:px-8 max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
                Your privacy is maintaining the trust you place in LuxeMarket.
            </p>

            <div className="glass p-8 rounded-xl text-left space-y-4 mb-8 w-full">
                <p className="text-white/80">
                    This is a placeholder for the Privacy Policy. In a production environment, this page would contain detailed information about how we collect, use, and protect your data.
                </p>
                <p className="text-white/80">
